    ...
    <div className="flex min-h-screen w-full font-sans">
      ...
      <div className="flex w-full flex-col justify-center bg-white px-8 py-12 md:w-1/2 md:px-16 lg:px-24 xl:px-32">
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="mb-10 flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#00a651] p-2">
               {/* Dummy Logo Hexagon */}
               <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-full w-full text-white">
                  <path d="M12 2L2 7.77778V16.2222L12 22L22 16.2222V7.77778L12 2Z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"/>
                  <path d="M12 22V12L2 6.22223" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"/>
                  <path d="M22 6.22223L12 12V22" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"/>
                  <path d="M12 12L22 6.22223" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"/>
               </svg>
            </div>
      ...
      <div className="hidden w-1/2 flex-col items-center justify-center bg-[#0a1630] md:flex relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center">
          <div className="mb-6 flex h-48 w-48 items-center justify-center rounded-2xl bg-white p-6 shadow-2xl">
             <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-full w-full text-[#00a651]">
                  <path d="M12 2L2 7.77778V16.2222L12 22L22 16.2222V7.77778L12 2Z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"/>
                  <path d="M12 22V12L2 6.22223" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"/>
                  <path d="M22 6.22223L12 12V22" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"/>
                  <path d="M12 12L22 6.22223" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"/>
